function info = fcnTestBBXtxt(varargin)
...
% text file of rectangles
 ...
 for id = 1:Ncluster
  ...
  %img = imread('/home/dena/datasets/SVHN/train/30111.jpg');
   %fprintf(fileID,'%d,%d,%d,%d,%d,%d,%d,%d\r\n',minC,minR,maxC,minR,maxC,maxR,minC,maxR);
   %fprintf(fileID,'%d,%d,%d,%d,%d,%d,%d,%d\r\n',minR,minC,minR,maxC,maxR,maxC,maxR,minC);
   %fprintf(fileID,'%d,%d,%d,%d,%d,%d,%d,%d\r\n',minC,minR,minC,maxR,maxC,maxR,maxC,minR);
